      ...
      <header className="mb-10 card-animate">
        ...
        <div className="mt-6 flex flex-wrap gap-6">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-xs font-medium text-slate-400">Real-time Processing</span>
          </div>
          <div className="flex items-center gap-2.5">
            <div className="h-px w-6 bg-gradient-to-r from-transparent to-violet-500"></div>
            <span className="text-xs font-medium text-slate-400">Cycle Detection</span>
          </div>
          <div className="flex items-center gap-2.5">
            <div className="h-px w-6 bg-gradient-to-r from-transparent to-amber-500"></div>
            <span className="text-xs font-medium text-slate-400">Interactive Graph</span>
          </div>
        </div>
      </header>
